...
- **Why this glyph**: this integration's primary example use case is guarding a heater/cooler relay by run time and cooldown — a droplet + thermometer reads as "temperature-guarded device" at a glance.
